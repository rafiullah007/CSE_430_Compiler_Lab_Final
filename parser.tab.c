...
{
       0,   106,   106,   110,   111,   115,   119,   123,   129,   130,
     134,   135,   136,   137,   144,   145
};
#endif
...
{
     -11,     8,     1,   -11,    -4,    12,     3,   -11,    11,     6,
      11,   -11,   -11,    11,    11,    26,   -11,    13,   -11,    22,
      11,    11,    11,    11,   -11,    14,   -11,    -8,    -8,   -11,
     -11,   -11
};
...
{
       3,     0,     2,     1,     0,     0,     0,     4,     0,     0,
       0,     8,     9,     0,     0,     0,     5,     0,    15,     0,
       0,     0,     0,     0,     6,     0,    14,    10,    11,    12,
      13,     7
};
...
{
      17,    22,    23,    18,    19,     4,     5,     6,     3,     8,
      27,    28,    29,    30,    11,    12,     9,    10,    16,    13,
      20,    21,    22,    23,     0,    14,    31,     0,    25,    20,
      21,    22,    23,    20,    21,    22,    23,    26,    24
};

static const yytype_int8 yycheck[] =
{
      10,     9,    10,    13,    14,     4,     5,     6,     0,    13,
      20,    21,    22,    23,     3,     4,     4,    14,    12,     8,
       7,     8,     9,    10,    -1,    14,    12,    -1,    15,     7,
       8,     9,    10,     7,     8,     9,    10,    15,    12
};
...
{
       0,    17,    18,     0,     4,     5,     6,    19,    13,     4,
      14,     3,     4,     8,    14,    20,    12,    20,    20,    20,
       7,     8,     9,    10,    12,    15,    15,    20,    20,    20,
      20,    12
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: INT IDENTIFIER ';'  */
#line 115 "parser.y"
                         {
          declare_variable((yyvsp[-1].id));
          free((yyvsp[-1].id));
      }
#line 1175 "parser.tab.c"
    break;

  case 6: /* statement: IDENTIFIER '=' expression ';'  */
#line 119 "parser.y"
                                    {
          set_variable((yyvsp[-3].id), (yyvsp[-1].num));
          free((yyvsp[-3].id));
      }
#line 1184 "parser.tab.c"
    break;

  case 7: /* statement: PRINT '(' expression ')' ';'  */
#line 123 "parser.y"
                                   {
          printf("%d\n", (yyvsp[-2].num));
      }
...
#line 130 "parser.y"
                 {
          (yyval.num) = get_variable((yyvsp[0].id));
          free((yyvsp[0].id));
      }
